...
client.query('CREATE TABLE IF NOT EXISTS products(id NUMERIC not null, category VARCHAR(40) not null,  name VARCHAR(40) not null,  quantity_in_stock SERIAL not null, quantity_remaining SERIAL not null, price SERIAL not null, size REAL not null, image_url VARCHAR(20000))', (err, done) => {
  done();
});
